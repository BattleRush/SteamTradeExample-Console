...
namespace SteamBotExample.Steam2FA
{
	public class SteamGuardAccount
	{
		...
		public bool DeactivateAuthenticator()
		{
			...
			try
			{
				string response = SteamWebAuth.MobileLoginRequest(APIEndpoints.STEAMAPI_BASE + "/ITwoFactorService/RemoveAuthenticator/v0001", "POST", postData);
		...
		public Confirmation[] FetchConfirmations()
		{
			...
			string response = SteamWebAuth.Request(url, "GET", null, cookies);
		...
		private bool _sendConfirmationAjax(Confirmation conf, string op)
		{
			...
			string response = SteamWebAuth.Request(url + queryString, "GET", null, cookies, null);
